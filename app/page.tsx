...
>
  ...
  <div className="flex justify-center md:justify-end">
    <img
      src="/headshot.png"
      alt="headshot"
      className="hero-image h-64 w-64 rounded-2xl border border-white/10 object-cover object-top md:h-80 md:w-80"
    />
  </div>
</div>
      </section>
              ...
              <div className="flex justify-center md:justify-end">
                <div className="w-full max-w-md h-[420px] overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03]">
                 <img
                   ...
                   alt="SERE graduation"
                    className="w-full h-full object-cover object-[55%_30%] hover:scale-105 transition-transform duration-300"
                 />
                </div>
               </div>
            </section>
